...
<h4 class="page-header">Synthèse statistique globale</h4>
<div class="row">
            ...
            <div class="box-header">
           	...
           	<div class="box-content no-padding">
                <table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
                    ...
                    <tr align="center">
                        <td>
							<button type="button" class="btn-circle" style="background-color : red;"><span id="glob_panne"></span></button><br>
							<!-- <i>Moyenne : </i> <span id="glob_panne_decl_moy"></span> -->
							
						</td>
						<td>
							<button type="button" class="btn-circle" style="background-color : blue;"><span id="glob_prise_en_charge"></span></button>
						 </td>
                        
                        <td>
								<button type="button" class="btn-circle"  style="background-color : orange;"><span id="glob_rep_encours"></span></button>
						</td>
					
						 <td>
								<button type="button" class="btn-circle"  style="background-color : green;"><span id="glob_marche"></span></button><br>
