			...
			<table class="table table-bordered table-striped table-hover table-heading " id="datatable-3">
					<thead style="font-size: 11px;valign:center;">
						<tr>
							...
							<th style="text-align:center;width:100px">Délai moyen d’indisponibilité (Jours)</th>
					...
					<tr name="<?php echo $forage['IDOuvrage']; ?>">
							...
							<td><span class="badge"><?php  $nbreMoyPanne = $nbrePanne / Stat::dateRange(StatForage::$periodeDebut, StatForage::$periodeFin);echo number_format((float) $nbreMoyPanne , 4, '.', ''); ?> </td>
							...
							<td><span class="badge"><?php  $nbreMoyReparation = $nbreReparation / Stat::dateRange(StatForage::$periodeDebut, StatForage::$periodeFin);echo number_format((float) $nbreMoyReparation , 4, '.', ''); ?> </td>
													
							<td name="<?php echo $forage['IDOuvrage'] . "_delaiMoyReparation";?>"><span class="badge"><?php $delaiMoyReparation = Stat::FormatTime(StatForage::delaiMoyReparation($forage['IDOuvrage'])); if ($delaiMoyReparation > 0) echo $delaiMoyReparation; else echo '';?></span></td>
							<td name="<?php echo $forage['IDOuvrage'] . "_delaiMoyIndisponibilite";?>"><span class="badge"><?php $delaiMoyIndisponibilite = Stat::FormatTime(StatForage::delaiMoyIndisponibilite($forage['IDOuvrage'])); if ($delaiMoyIndisponibilite > 0) echo $delaiMoyIndisponibilite; else echo '';?></span></td>
