	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa"></i>
					<span>Liste des reparateurs <span class="libStatGen"></span></span>
				</div>
				<div class="box-icons">
			...
			<table class="table table-bordered table-striped table-hover table-heading " id="datatable-1">
					...
					<tr name="<?php echo $reparateur['IDReparateur']; ?>">
							<td><?php echo $reparateur['IDReparateur']; ?></td>
							<td name="<?php echo $reparateur['IDReparateur'] . "_nomPrenoms";?>"><?php echo $reparateur['NomRep'] . ' ' . $reparateur['PrenomsRep']; ?></td>
							...
							<td name="<?php echo $reparateur['IDReparateur'] . "_delaiMoyReparation";?>"><span class="badge"><?php $delaiMoyReparation = Stat::FormatTime(StatReparateur::delaiMoyReparation($reparateur['IDNumAppel'])); echo $delaiMoyReparation;?></span></td>
							<td name="<?php echo $reparateur['IDReparateur'] . "_nbreTransfertAbsence";?>"><span class="badge"><?php echo StatReparateur::nbreTransfertAbsence($reparateur['IDNumAppel']); ?></span></td>
							<td name=""><?php echo ''; ?></td>
							...
							<td name="<?php echo $reparateur['IDReparateur'] . "_palmares";?>"><span class="badge alert-danger"><?php echo StatReparateur::palmares($tauxRealisation, strtotime($delaiMoyReparation)); ?></span></td>
