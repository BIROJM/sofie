	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa"></i>
					<span>Liste des agents <span class="libStatGen"></span></span>
				</div>
				<div class="box-icons">
			...
			<table class="table table-bordered table-striped table-hover table-heading " id="datatable-1">
					...
					<tr name="<?php echo $agent['IDAgent']; ?>">
							...
							<td name="<?php echo $agent['IDAgent'] . "_nbreMoyReparation";?>"><span class="badge"><?php $nbreMoyReparation =  number_format(StatAgent::nbreMoyenReparation($agent['IDNumAppel']) , 2,'.', ''); echo $nbreMoyReparation;?></span></td>
							...
							<td name="<?php echo $agent['IDAgent'] . "_delaiMoyReparation";?>"><span class="badge"><?php $delaiMoyReparation = Stat::FormatTime(StatAgent::delaiMoyReparation($agent['IDNumAppel'])); echo $delaiMoyReparation;?></span></td>
							<td name="<?php echo $agent['IDAgent'] . "_nbreTransfertAbsence";?>"><span class="badge"><?php echo StatAgent::nbreTransfertAbsence($agent['IDNumAppel']); ?></span></td>
							<td name=""><?php echo ''; ?></td>
							...
							<td name="<?php echo $agent['IDAgent'] . "_palmares";?>"><span class="badge alert-danger"><?php echo StatAgent::palmares($tauxRealisation, strtotime($delaiMoyReparation)); ?></span></td>
