<input type="hidden" name="actualPage" class="actualPage" value="reparateur">
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			<li><a href="index.html">Statistiques SOFIE</a></li>
			<li><a href="#">Rendement des réparateurs</a></li>
		</ol>
	</div>
</div>
<h4 class="page-header">Rendement des réparateurs</h4>
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" role="form">
								...
								<div class="col-sm-3">
                                   Reparateur :  <select id="reparateurs" class=" populate placeholder">
                                              </select>
                                </div>
								
								<div class="col-sm-2 pull-right">
									<button id="showStat_reparateur" type="button" class="btn btn-primary" style="margin-top : 20px; float: right;">Afficher</button>
								</div>
                        </form>
                    </div>
                </div>
