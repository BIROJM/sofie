...
then
	...
	# cd /var/www/html/sofiev4/api/scripts/sofie_sendsms_script && php /var/www/html/sofiev4/api/scripts/sofie_sendsms_script/sofie_sendsms_script.php >> /var/log/sofie_sendsms.log &
